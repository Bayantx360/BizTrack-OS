...
# ─────────────────────────────────────────────
st.set_page_config(
    page_title="BizTrack — SME Dashboard",
    page_icon="📊",
    layout="wide",
...
/* Nuclear option: hide the ligature text itself, keep button clickable */
...
.kpi-card { padding: 0.65rem 0.8rem; margin-bottom: 0.45rem; border-radius: 10px; }
...
<div style="font-size:2rem;font-weight:800;color:#0f172a;">📊 BizTrack</div>
</div>
    """, unsafe_allow_html=True)
...
Your access period has ended. Renew to continue using BizTrack.
</div>
